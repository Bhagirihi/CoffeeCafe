...
export default function AdminPage() {
  ...
  const handleSaveItem = (e) => {
    ...
    const sectionIndex = menuData.sections.findIndex(
    ...
    if (editingItem) {
      ...
      if (section.categories) {
        for (let cat of section.categories) {
          ...
          if (itemIndex !== -1) {
            updatedData.sections[sectionIndex].categories.find(
              (c) => c.name === cat.name
  ...
  const handleDeleteItem = (sectionId, itemId) => {
    ...
    const updatedData = { ...menuData };
    const sectionIndex = updatedData.sections.findIndex(
      (s) => s.id === sectionId
    );
  ...
  const handleDeleteSection = (sectionId) => {
    if (
      !confirm(
        "Are you sure you want to delete this section? All items will be deleted too."
      )
    )
      return;
  ...
  const syncMenuDataToFile = async (menuDataToSync) => {
    try {
      ...
      if (!response.ok) {
        ...
        showAlert(
          `Menu updated in memory, but file sync failed: ${result.error}`,
          "error"
        );
      } else {
      ...
      showAlert(
        "Menu updated in localStorage, but file sync failed. Please check console.",
        "error"
      );
    }
  };
  ...
  const updateMenuDataAndSync = (newData) => {
    console.log("Updating menu data and syncing to file:", newData);
    ...
    return (
      ...
      >
        ...
        >
          ...
          <form onSubmit={handleLogin}>
            <input
              ...
              style={{
                ...
                background: "var(--eerie-black-1)",
                border: `1px solid ${
                  loginError ? "#ff4444" : "var(--white-alpha-10)"
                }`,
                borderRadius: "5px",
                color: "var(--white)",
                fontSize: "var(--fontSize-body-4)",
          ...
          >
            Default password:{" "}
            <strong style={{ color: "var(--gold-crayola)" }}>admin123</strong>
          </p>
        </div>
      </div>
    );
            ...
            style={{
              ...
              background:
                alert.type === "success"
                  ...
                  : "rgba(255, 68, 68, 0.2)",
              border: `1px solid ${
                alert.type === "success" ? "#44ff44" : "#ff4444"
              }`,
        ...
        >
          ...
          <div id="subscriptions-container">
            {subscriptions.length === 0 ? (
              ...
              >
                No subscriptions found. Subscriptions will appear here when
              ...
              [...subscriptions]
                ...
                .map((subscription, index) => {
                  const subscribedDate =
                    subscription.created_at || subscription.timestamp
                      ? formatDate(
                          subscription.created_at || subscription.timestamp
                        )
                      : "N/A";
            ...
            {sortedBookings.length === 0 ? (
              ...
              sortedBookings.map((booking, index) => {
                ...
                const bookingTime = booking.time
                  ...
                  : "N/A";
                const submittedDate = booking.created_at
                  ? formatDate(booking.created_at)
                  : "N/A";
                const isExpanded = expandedBookings[booking.id] || false;
                const guests =
                  typeof booking.guests === "string"
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          padding: "20px",
                          borderRadius: "8px",
                          border: item.isSpecialDish
                            ? "2px solid var(--gold-crayola)"
                            : "1px solid var(--white-alpha-10)",
                        }}
                      >
                        <div
                          style={{
                        ...
                        >
                          <button
                            onClick={() =>
                              openEditItemModal(section.id, item.id)
                            }
                            style={{
                              padding: "10px 20px",
                              border: "2px solid var(--gold-crayola)",
              ...
              <div style={{ marginBottom: "20px" }}>
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      <option value="/assets/images/menu-1.png">
                        Menu Image 1
                      </option>
                      <option value="/assets/images/menu-2.png">
                        Menu Image 2
                      </option>
                      <option value="/assets/images/menu-3.png">
                        Menu Image 3
                      </option>
                      <option value="/assets/images/menu-4.png">
                        Menu Image 4
                      </option>
                      <option value="/assets/images/menu-5.png">
                        Menu Image 5
                      </option>
                      <option value="/assets/images/menu-6.png">
                        Menu Image 6
                      </option>
                    </select>
                  </div>
                ...
                >
                  <input
                    ...
                    onChange={(e) =>
                      setItemFormData({
                        ...itemFormData,
                        isSpecialDish: e.target.checked,
                      })
                    }
                    style={{
                      width: "20px",
